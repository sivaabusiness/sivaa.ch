...
const translations = {
    fr: {
        ...
        "hero.subtitle": "La brosse à dents naturelle que le monde utilise depuis 1000 ans — sélectionnée avec la précision suisse. Antibactérien, blanchissant, biodégradable. Livraison en 72h à travers toute la Suisse.",
        ...
        "faq.q1": "Comment utiliser le Siwak pour la première fois ?",
        "faq.a1": "Trempez l'extrémité du bâton dans de l'eau pendant 5 minutes pour l'assouplir. Mâchez doucement pour effilocher les fibres et former une brosse naturelle. Frottez vos dents et vos gencives en mouvement circulaire pendant 2-3 minutes. Rincez. Coupez l'extrémité usée et recommencez.",
        "faq.q2": "Combien de temps dure un bâton de Siwak ?",
        "faq.a2": "Un bâton SIVÀA dure en moyenne 2 à 4 semaines selon l'utilisation. Coupez l'extrémité utilisée (environ 1cm) après chaque séance pour toujours avoir une surface fraîche et hygiénique.",
        "faq.q3": "Quels sont les délais et frais de livraison ?",
        "faq.a3": "Livraison en 2-3 jours ouvrés via Swiss Post pour CHF 9.00. Toutes les commandes passées avant 14h sont expédiées le jour même (jours ouvrés). Vous recevez un email de confirmation avec numéro de suivi.",
        "faq.q4": "Dois-je utiliser du dentifrice en plus du Siwak ?",
        "faq.a4": "Personnellement, il m'arrive les jours où j'ai envie d'avoir la bouche plus fraîche d'utiliser du dentifrice avec du siwak. Mais le Siwak contient naturellement ses propres agents nettoyants, abrasifs doux et antibactériens. Il se suffit donc à lui tout seul. Faites-le donc au ressenti !",
        "faq.q5": "Le Siwak convient-il aux enfants et femmes enceintes ?",
        "faq.a5": "Le Siwak est un produit 100% naturel, sans additifs chimiques. Il est généralement considéré comme sûr pour les enfants à partir de 6 ans (sous supervision) et les femmes enceintes. En cas de doute, consultez votre médecin ou dentiste.",
        "faq.q6": "Le Siwak est-il aussi efficace qu'une brosse à dents classique ?",
    ...
    de: {
        ...
        "hero.subtitle": "Die natürliche Zahnbürste, die die Welt seit 1000 Jahren verwendet — ausgewählt mit Schweizer Präzision. Antibakteriell, aufhellend, biologisch abbaubar. Lieferung innert 72h in der ganzen Schweiz.",
